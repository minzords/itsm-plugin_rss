...
$rssfeed = new PluginRssfeedRssfeed();
...
if (isset($_POST["add"])) {
   ...
   if (Session::getCurrentInterface() == "helpdesk") {
      Html::helpHeader(PluginRssfeedRssfeed::getTypeName(Session::getPluralNumber()), '', $_SESSION["glpiname"]);
   } else {
      Html::header(PluginRssfeedRssfeed::getTypeName(Session::getPluralNumber()), '', "tools", "rssfeed");
   }
