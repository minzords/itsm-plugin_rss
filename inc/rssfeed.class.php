 ...
 * @since 0.84
**/
class PluginRssfeedRssfeed extends CommonDBVisible implements ExtraVisibilityCriteria {
   ...
   **/
   ...
   function post_getFromDB() {
      ...
      // Users
      $this->users    = PluginRssfeedUser::getUsers($this->fields['id']);

      // Entities
      $this->entities = PluginRssfeedEntity::getEntities($this->fields['id']);

      // Group / entities
      $this->groups   = PluginRssfeedGroup::getGroups($this->fields['id']);

      // Profile / entities
      $this->profiles = PluginRssfeedProfile::getProfiles($this->fields['id']);
   }
   ...
   **/
   function cleanDBonPurge() {
      ...
      $this->deleteChildrenAndRelationsFromDb(
         [
            PluginRssfeedEntity::class,
            PluginRssfeedGroup::class,
            PluginRssfeedProfile::class,
            PluginRssfeedUser::class,
         ]
      );
   }
   ...
   **/
   ...
   static function showListForCentral($personal = true) {
      ...
      if ($personal) {
         ...
         $titre = "<a href='".$CFG_GLPI["root_doc"]."/plugin/rssfeed/front/rssfeed.php'>".
      ...
      if (($personal && self::canCreate())
         ...
         echo "<a href='".PluginRssfeedRssfeed::getFormURL()."'>";
